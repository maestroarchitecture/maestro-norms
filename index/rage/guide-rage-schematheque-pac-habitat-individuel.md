---
title: "guide-rage-schematheque-pac-habitat-individuel.pdf"
source_url: https://media.xpair.com/pdf/pompe-a-chaleur/guide-rage-schematheque-pac-habitat-individuel.pdf
site: 
source_date: 
doc_sha256: 27b731e03d17056b29eefb583b5e461e69f93d17e02bfbce5efabb47dffc09f9
lot: 04
dtu_refs: [DTU 65.x]
...
# guide-rage-schematheque-pac-habitat-individuel.pdf
...
### 2.1. Préambule : performances des pompes à chaleur


## Règles générales pour optimiser le fonctionnement des pompes à chaleur
...
### 2.2. Maîtriser le débit dans la pompe à chaleur
...
### 2.3. Privilégier une production à température variable, régulée en fonction de la température extérieure
...
satisfaisante.
la régulation, la sonde de température extérieure doit
! Pour
...
### 2.5. Pompe à chaleur avec chaudière en relève : fonctionnement simultané ou alterné
...
peut être adapté à une chaudière avec vanne à
! Letroisschéma
voies de régulation en mélange. Dans ce cas, elle peut
...
pompe à chaleur ne participe pas à la production d'eau
! Lachaude
sanitaire. Elle est produite par la chaudière et sa
régulation intégrée.
Lorsque la température mesurée dans le ballon d'ECS est insuffisante,
...
variable en fonction de la température extérieure. La mesure de la
température au retour et/ou au départ de la machine régule le fonctionnement du compresseur, soit en tout ou rien, soit en progressif.
peut être adapté à une chaudière produisant
! Leuneschéma
température d'eau variable en fonction de la tempé-
rature extérieure. Dans ce cas, une vanne à trois voies de
...
le circuit d'émetteurs, considérer le débit corres! Dans
pondant à la puissance installée des émetteurs. Dans la
...
schéma peut être conçu avec un circulateur unique sur le
! Ce
...
neuf, la commande d'une vanne de régulation à deux
! En
...
Le circulateur est choisi pour un débit de 1,7 m3/h et une hauteur manométrique
totale de 1,5 m eau.
des différences de pertes de charge entre le
! Compte-tenu
...
circulateurs du circuit primaire doivent être dimension! Les
nés au plus juste afin de ne pas engendrer de consommations électriques excessives.
...
### 4.1. Dimensionnement du vase d'expansion


## Dimensionnement des équipements hydrauliques
...
la formule, les pressions sont exprimées en valeurs
! Dans
...
3 bar
le catalogue du fabricant, toujours choisir un vase de
! Dans
...
- ContenanceRéseau
ρ x Cp x DifférentielRégulation
...
contenance du réseau dépend du type d'émetteur (le
! Lavolume
d'un réseau de plancher chauffant est plus important que celui d'un réseau de radiateurs) et de la présence
...
### 4.4. Dimensionnement des découplages hydrauliques
...
### 5.1. Prévention de l'embouage et protection de la pompe à chaleur
...
plus d'informations, se référer au rapport « Conception
! Pour
...
Pompe à chaleur assurant Produit bénéficiant d'un
Disconnecteur de type CA (2)
(1)
les besoins de chauffage avis favorable de l'ANSES
uniquement ou chauffage Produit ne bénéficiant
Disconnecteur de type BA (3) (4)
– refroidissement sans
pas d'un avis favorable de
production d'eau chaude l'ANSES (1) – catégorie 4 ou
sanitaire
5 selon NF EN 1717
...
contient de l'antigel, la vidange doit s'effectuer
! Sidansle réseau
un récipient prévu pour récolter le liquide caloporteur
...
## Détermination des pertes de charge pour un débit autre que le débit spécifié
...
ce document, les pressions sont exprimées en mètre
! Dans
...
Ce programme est une application du Grenelle Environnement. Il vise à revoir l’ensemble des règles de construction, aﬁn de réaliser des économies d’énergie dans le bâtiment et de réduire les émissions de gaz à effet de serre.
